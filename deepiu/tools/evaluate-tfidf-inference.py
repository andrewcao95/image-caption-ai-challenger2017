...
result_file = model_path + '.tfidf_top%d.evaluate-inference.txt' % top_n
...
command = """python /home/gezi/mine/hasky/deepiu/tools/caption-tfidf-inference.py \\
  ...
  --top_n={} \\
  """.format(model_path, input_file, result_file, batch_size, feature_name, image_checkpoint_file, top_n)
