...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string('model_dir', '/home/gezi/mount/temp/image-classification/ai-challenger/model.caption/inceptionV4.finetune.lr001/', '')
...
def main(_):
  ...
  result_file2 = './scene.inceptionV4.%s.pkl' % FLAGS.type 
