...
#mlt ensemble.train.detect.txt --name 0,1 -group 0  -cl gbrank -wr 1 -excl model,vote,tfidf -smooth 0.5 --entropy 0.5 -nt 10 -mil 100  -ntree 100 --nl 128 --lr 0.025 
mlt ensemble.train.final.txt --rank=1  -cl gbrank -wr 1 -smooth 0.5 --entropy 0.5 -nt 12 -mil 100  -ntree 100 --nl 128 --lr 0.025  -maxfs 40 -excl model,vote,tfidf,phone,person --rs 1138636380
calc-rank-score.py 
