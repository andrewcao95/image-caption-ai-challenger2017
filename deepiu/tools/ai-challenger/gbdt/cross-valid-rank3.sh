...
mlt ensemble.train.detect_person.txt --name 0,1 -group 0  -cl gbrank -wr 1 -excl model,vote,tfidf -smooth 0.5 --entropy 0.5 -nt 10 -mil 100  -ntree 500 --nl 128 --lr 0.025 
calc-rank-score.py 
