...
#mlt ensemble.train.detect.txt --name 0,1 -group 0  -cl gbrank -wr 1 -excl model,vote,tfidf -smooth 0.5 --entropy 0.5 -nt 10 -mil 100  -ntree 100 --nl 128 --lr 0.025 
mlt ./ensemble.train.modifylabel.txt --rank=1  -cl gbrank -wr 1 -smooth 0.5 --entropy 0.5 -nt 10 -mil 100  -ntree 10 --nl 32 --lr 0.2  -maxfs 30 -excl model,vote,tfidf,phone,person --rs 1138636380 -k 2 --writeTopResultOnly=1
calc-rank-score.py 
