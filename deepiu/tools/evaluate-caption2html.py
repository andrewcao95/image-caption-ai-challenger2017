...
try:
  ...
  result_dir = os.path.join(os.path.dirname(infile), 'evaluate.html') 
...
img_dir = '/data2/data/ai_challenger/ai_challenger_caption_validation_20170910/caption_validation_images_20170910'
if FLAGS.img_dir:
...
for line in open(infile):
  ...
  if info:
    print(img_html.format(img, img_id, caption, info), file=out)
  else:
