...
#    | python ./merge-pic-feature.py caption_validation_annotations_20170910.withweights.txt > caption_validation_annotations_20170910.atten.feature.txt


cat img_atten_feature.txt | python ./merge-pic-feature-withweights.py \
    caption_validation_annotations_20170910.withweights.txt > caption_validation_annotations_20170910.atten.feature.txt 
