...
#    | python ./merge-pic-feature-withweights.py caption_validation_annotations_20170910.withweights.txt > caption_validation_annotations_20170910.atten.feature.resnet152.txt


cat img_atten_feature_resnet152.txt | python ./merge-pic-feature-withweights.py \
    caption_validation_annotations_20170910.withweights.txt > caption_validation_annotations_20170910.atten.feature.resnet152.txt
