conf_path=./prepare/default/app-conf/ai-challenger/seq-basic-atten-keywords
...
model_dir=$base/temp/image-caption/ai-challenger/model.v4/showattentell.coverage.keywords.sigmoid
