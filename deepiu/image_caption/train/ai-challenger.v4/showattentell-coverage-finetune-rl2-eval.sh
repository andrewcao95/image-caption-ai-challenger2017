...
model_dir=$base/temp/image-caption/ai-challenger/model.v4/showattentell.coverage.finetune.rl2
...
cp $0 $model_dir 
 ...
 # --learning_rate_values=0.00002,0.00001,0.000001,0.0000001 \
 # --learning_rate_epoch_boundaries=22,23,24 \
python ./train.py \
  ...
  --use_finetune_step=1 \
  --learning_rate_values=0.00005,0.00001,0.000005 \
  --learning_rate_epoch_boundaries=3,6 \
  --num_epochs=100 \
  --num_sampled 0 \
  ...
  --caption_file=$model_dir/'evaluate-inference.txt' \
