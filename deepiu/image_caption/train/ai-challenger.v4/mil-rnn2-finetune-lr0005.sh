...
model_dir=$base/temp/image-caption/ai-challenger/model.v4/mil.rnn2.finetune.lr0005
...
python ./train.py \
  ...
  --use_finetune_step=1 \
  --learning_rate_values=0.005,0.001,0.0005,0.0001 \
  --learning_rate_epoch_boundaries=10,25,30 \
  --num_epochs=40 \
