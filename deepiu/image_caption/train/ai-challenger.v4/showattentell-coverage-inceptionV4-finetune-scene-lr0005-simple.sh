...
model_dir=$base/temp/image-caption/ai-challenger/model.v4/showattentell.coverage.inceptionV4.finetune.scene.lr0005.simple
...
python ./co-train.py \
  ...
  --learning_rate_epoch_boundaries=5,11 \
  --num_epochs=100 \
  --num_sampled 0 \
