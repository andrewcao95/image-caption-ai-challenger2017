...
model_dir=$base/temp/image-caption/ai-challenger/model.v4/mil.idf2.finetune.start.lr001
...
python ./train.py \
  --train_input $train_output_path/'train-*,'$scene_train_output_path/'train-*,' \
  ...
  --learning_rate_epoch_boundaries=5,15,20,25,30 \
  --num_epochs=40 \
