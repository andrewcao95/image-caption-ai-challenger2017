...
fetch_conf_path=./prepare/default/app-conf/ai-challenger/fetch-finetune/
conf_path2=./prepare/default/app-conf/ai-challenger/seq-basic-atten/

source $fetch_conf_path/config 
fetch_train_output_path=$train_output_path
...
# --train_input $train_output_path/'train-*,',$fetch_train_output_path/'train*' \
# --train_input $fetch_train_output_path/'train*' \
python ./train.py \
  --train_input $train_output_path/'train-*,',$fetch_train_output_path/'train*' \
  ...
  --beam_size 10 \
  --decoder_max_words 11 \
  --input_with_end_mark 1 \
  --emb_dim 512 \
  --rnn_hidden_size 512 \
