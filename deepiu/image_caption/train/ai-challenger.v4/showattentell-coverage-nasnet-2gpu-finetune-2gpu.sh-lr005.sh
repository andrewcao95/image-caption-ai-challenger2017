...
model_dir=$base/temp/image-caption/ai-challenger/model.v4/showattentell.coverage.nasnet.2gpu.finetune.2gpu.lr005
...
python ./train.py \
  ...
  --use_finetune_step=1 \
  --learning_rate_values=0.05,0.005,0.001 \
  --learning_rate_epoch_boundaries=7,15 \
  --num_epochs=100 \
  --num_sampled 0 \
