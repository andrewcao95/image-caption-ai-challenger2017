...
model_dir=$base/temp/image-caption/ai-challenger/model.v4/showattentell.coverage.resnet152.finetune
...
python ./train.py \
  ...
  --image_checkpoint_file=$base/'data/image_model_check_point/resnet_v2_152.ckpt' \
  ...
  --learning_rate_epoch_boundaries=7,50 \
  --num_epochs=100 \
  --num_sampled 0 \
