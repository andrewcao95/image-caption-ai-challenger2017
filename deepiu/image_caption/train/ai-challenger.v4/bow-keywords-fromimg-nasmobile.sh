...
model_dir=$base/temp/image-caption/ai-challenger/model/bow.keywords.fromimg.nasmobile
...
python ./train.py \
  ...
  --image_checkpoint_file=$base/'data/image_model_check_point/nasnet_mobile/model.ckpt' \
  --image_features_batch_norm 1 \
  --image_features_dropout 0 \
  --image_endpoint_feature_name final \
