conf_path=./prepare/default/app-conf/ai-challenger/seq-basic-incpetionV4/

cp $conf_path/conf.py .
source $conf_path/config  

model_dir=/home/gezi/new/temp/image-caption/ai-challenger/model.v4/showandtell.inceptionV4
