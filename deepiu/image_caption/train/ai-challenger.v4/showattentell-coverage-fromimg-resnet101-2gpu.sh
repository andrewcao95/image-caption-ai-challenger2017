...
model_dir=$base/temp/image-caption/ai-challenger/model.v4/showattentell.coverage.fromimg.resnet101.2gpu
...
python ./train.py \
  ...
  --image_checkpoint_file=$base/'data/image_model_check_point/openimage/resnet101/oidv2-resnet_v1_101.ckpt' \
  --num_pretrain_image_classes 5000 \
  ...
  --learning_rate_epoch_boundaries=5,8,12 \
  --num_epochs=22 \
