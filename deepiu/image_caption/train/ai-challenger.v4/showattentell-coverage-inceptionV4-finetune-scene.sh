...
model_dir=$base/temp/image-caption/ai-challenger/model.v4/showattentell.coverage.inceptionV4.finetune.scene
...
python ./co-train.py \
  ...
  --learning_rate_values=0.005,0.001,0.0001 \
  --learning_rate_epoch_boundaries=15,25 \
  --num_epochs=100 \
  --num_sampled 0 \
