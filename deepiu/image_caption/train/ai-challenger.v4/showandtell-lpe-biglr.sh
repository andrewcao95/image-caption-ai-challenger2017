...
#lpe means loss per example
model_dir=/home/gezi/new/temp/image-caption/ai-challenger/model.v4/showandtell.lpe.biglr
...
python ./train.py \
  ...
  --learning_rate=0 \
  --learning_rate_values=0.2,0.1,0.01,0.001,0.0001 \
  --learning_rate_epoch_boundaries=4,10,15,20 \
