...
model_dir=$base/temp/image-caption/ai-challenger/model.v4/showattentell.bahdanau.nasnet.finetune.2gpu.lr0005.lr00005
...
python ./train.py \
  ...
  --use_finetune_step=1 \
  --learning_rate_values=0.0005,0.0001 \
  --learning_rate_epoch_boundaries=40 \
  --num_epochs=100 \
  --num_sampled 0 \
