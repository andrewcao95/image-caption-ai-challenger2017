...
model_dir=$base/temp/image-caption/ai-challenger/model.v4/showattentell.coverage.fromimg.nasnet.2gpu
...
python ./train.py \
  ...
  --learning_rate_values=0.1,0.05,0.005 \
  --learning_rate_epoch_boundaries=5,7 \
  --num_epochs=40 \
