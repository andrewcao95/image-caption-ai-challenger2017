...
model_dir=/home/gezi/new/temp/image-caption/ai-challenger/model.v4/showattentell.coverage.scene
...
python ./train.py \
  ...
  --scene_model=$base/'data/image_model_check_point/places365/resnet152_places365/model.pb' \
