...
model_dir=$base/temp/image-caption/ai-challenger/model.v4/showattentell.coverage.inceptionV4.finetune.scene.lr00005
...
python ./co-train.py \
  ...
  --learning_rate_values=0.0005,0.0001,0.00005 \
