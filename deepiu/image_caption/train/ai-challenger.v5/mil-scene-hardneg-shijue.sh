...
model_dir=$base/temp/image-caption/ai-challenger/model.v5/mil.scene.hardneg.shijue
...
python ./train.py \
  --train_input $scene_train_output_path/'train-*,'$shijue_scene_train_output_path/'train-*,' \
