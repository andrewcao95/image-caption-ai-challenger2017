...
model_dir=/home/gezi/new/temp/image-caption/ai-challenger/model.v5/showattentell.coverage.scene
...
python ./train.py \
  ...
  --image_checkpoint_file='/home/gezi/mount/temp/image-classification/ai-challenger/model.caption/inceptionResnetV2.finetune.lr001/model.ckpt-27.56-45000' \
  ...
  --learning_rate_values=0.1,0.05,0.025,0.0125,0.005,0.001,0.0001 \
  --learning_rate_epoch_boundaries=5,9,11,20,22,24 \
  --num_epochs=40 \
