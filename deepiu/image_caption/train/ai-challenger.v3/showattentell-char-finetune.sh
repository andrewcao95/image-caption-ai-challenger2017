conf_path=./prepare/default/app-conf/ai-challenger/char-finetune/
conf_path2=./prepare/default/app-conf/ai-challenger/char-atten/
...
model_dir=/home/gezi/new/temp/image-caption/ai-challenger/model.v3/showattentell.char.finetune
