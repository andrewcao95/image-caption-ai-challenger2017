...
model_dir=/home/gezi/new/temp/image-caption/ai-challenger/model.v3/showattentell.coverage.finetune.biglr2
...
#--learning_rate_values=0.1,0.005,0.0005,0.00005 \
#--learning_rate_epoch_boundaries=22,24,26 \
