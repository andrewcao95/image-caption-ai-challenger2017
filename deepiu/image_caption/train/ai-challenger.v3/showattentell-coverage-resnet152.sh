...
model_dir=/home/gezi/new/temp/image-caption/ai-challenger/model.v3/showattentell.coverage.resnet152
...
python ./train.py \
  ...
  --eval_rank 0 \
  --eval_translation 1 \
  --image_attention_size 49 \
  --image_endpoint_feature_name postnorm \
  --pre_calc_image_feature 1 \
  --image_model resnet_v2_152 \
  --image_width 299 \
  --image_height 299 \
