...
model_dir=/home/gezi/new/temp/image-caption/ai-challenger/model/showattentell.pointer.alignloss.finetune
...
python ./train.py \
  ...
  --image_encoder Rnn \
  --alignment_history 1 \
  --alignment_loss_ratio 0.1 \
  --showtell_attention_wrapper 1 \
  --eval_rank 0 \
  --eval_translation 1 \
