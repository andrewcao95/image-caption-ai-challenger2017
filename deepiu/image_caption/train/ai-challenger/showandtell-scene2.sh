...
model_dir=/home/gezi/new/temp/image-caption/ai-challenger/model/showandtell.scene2 
#assistant_model_dir=/home/gezi/new/temp/image-caption/ai-challenger/model/bow
assistant_model_dir=''
mkdir -p $model_dir

#valid_output_path2=/home/gezi/new/temp/image-caption/ai-challenger/tfrecord/seq-basic-finetune
...
python ./train.py \
  ...
  --algo show_and_tell \
  --scene_model /home/gezi/data2/data/image_model_check_point/places365/resnet152_places365/model.pb \
  --num_sampled 0 \
