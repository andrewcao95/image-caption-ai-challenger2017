...
model_dir=/home/gezi/new/temp/image-caption/ai-challenger/model/showattentell.twolayersatt
...
python ./train.py \
  ...
  --image_encoder Rnn \
  --alignment_history 1 \
  --alignment_loss_ratio 1. \
  --showtell_attention_wrapper 0 \
  --mix_pre_alignment 0 \
  --twolayers_attention_wrapper 1 \
  --num_epochs 14 \
  --debug 0 \
  --eval_rank 0 \
  --eval_translation 1 \
