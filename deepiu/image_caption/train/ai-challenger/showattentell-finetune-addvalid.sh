...
model_dir=/home/gezi/new/temp/image-caption/ai-challenger/model/showattentell.finetune.addvalid
...
python ./train.py \
	--train_input $dir/valid.train/'test-*' \
  --valid_input $dir/valid.small/'test-*' \
  ...
  --num_records_file  $dir/valid.train/num_records.txt \
  --model_dir=$model_dir \
