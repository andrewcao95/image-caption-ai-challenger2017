...
##JUST USE 1 GPU RIGHT NOW!! and not use assistant_model for finetune 
##NOTICE TODO FIXME there are bug when finetune using multi gpu mode, will train loss decrase but valid loss increase..
##might due to 2017-09-25 19:35:56.776237: I tensorflow/core/common_runtime/simple_placer.cc:667] 
##Ignoring device specification /device:GPU:1 for node 'show_and_tell/main/tower_1/map/while/TensorArrayReadV3/Enter' 
##because the input edge from 'show_and_tell/main/tower_1/map/TensorArray' is a reference connection and already has a device field set to /job:localhost/replica:0/task:0/device:CPU:0
##TODO has bug for using assistant_model for finetune FIXME
