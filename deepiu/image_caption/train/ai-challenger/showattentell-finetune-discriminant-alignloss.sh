...
model_dir=/home/gezi/new/temp/image-caption/ai-challenger/model/showattentell.finetune.discriminant.alignloss
...
python ./train.py \
  ...
  --algo show_and_tell \
  --image_encoder Rnn \
  --discriminant_loss_ratio 10. \
  --train_loss_per_example 1 \
  --alignment_history 1 \
  --alignment_loss_ratio 10. \
  --debug 1 \
  --eval_rank 0 \
  --eval_translation 1 \
